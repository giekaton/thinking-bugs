    ...
    <div>
      ...
      <div>
        ...
        <p>
          ...
          <em>selective-attention</em>. It narrows the worldview, concentrating on the negative things or events, or interpreting neutral things as negative.
        </p>
        ...
        <p>
          Write the negative thought in the
          <a
            rel="noreferrer noopener"
            aria-label="CBT journal (opens in a new tab)"
            href="https://thinkingbugs.com/cbt-app"
            target="_blank"
          >CBT journal</a>, and then challenge it. Is there a mental filter in action? It can be seen clearly when the thought is written in text.
        </p>
