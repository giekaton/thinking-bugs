<template>
  <div class="errors-list">
    <!-- Content -->
    <h2 style="line-height: 120%;margin-bottom:-10px;font-weight:300;">CBT Thinking Errors List</h2>
    <br>
    <span style="font-size:13px;">
      The classical cognitive distortions, as defined by the practice of Cognitive Behavioral Therapy (CBT).
